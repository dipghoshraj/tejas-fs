...
func (hm *HManager) CreateCusterMetadata(cluster *cosmicmodel.ClusterConsfig) error {
...
func (hm *HManager) NodeCreateParallel(ctx context.Context, cluster *cosmicmodel.ClusterConsfig) error {
